...
function Footer({
  ...
  return (
    <footer className="w-full h-[49px] bg-white border-t border-[#e0e0e0] flex justify-between items-center px-4">
      {/* Previous Resume */}
      <div onClick={handlePreviousResume} className="flex items-center space-x-2 mt-3 -mb-5">
      ...
      {/* Next Resume */}
      <div onClick={handleNextResume} className="flex items-center space-x-2 mt-3 -mb-5">
        <div className="text-[#6e6e6e] text-[15px] font-medium font-pretendard">
          다음 이력서
        </div>
